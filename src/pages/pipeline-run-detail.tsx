  ...
  if (!resolved || !workspaceNetwork) {
    return (
      <PipelineRunStatusPage
        ...
        message="This pipeline execution does not exist or is no longer available."
      />
    )
  }
            ...
            <dl className="mt-4 space-y-4">
              ...
              {definition ? (
                <AsideRow label="Definition">
                  <Link
                    to={href(`pipeline-definitions/${definition.id}`)}
...
function PipelineRunStatusPage({
  title,
  message,
  destructive,
}: {
