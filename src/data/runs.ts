...
export const workflowRuns: WorkflowRun[] = [
  ...
  {
    id: "wf-school-onboarding",
    workflowDefinitionId: "school-student-onboarding",
    networkId: "school",
  ...
  {
    id: "wf-school-absence",
    workflowDefinitionId: "school-absence-notice",
    networkId: "school",
    organizationId: "school-high",
    status: "Succeeded",
    currentStep: 3,
...
export const pipelineRuns: PipelineRun[] = [
  ...
  {
    id: "pl-school-sis",
    pipelineDefinitionId: "school-sis-ingest",
    networkId: "school",
  ...
  {
    id: "pl-school-attendance",
    pipelineDefinitionId: "school-attendance-capture",
    networkId: "school",
    organizationId: "school-high",
    status: "Succeeded",
    currentStage: 3,
